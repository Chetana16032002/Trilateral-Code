...
function sidetable() {
    ...
    if (width < 1050 || height < 623) { document.getElementById("prog-table-side").disabled=true;} //MINIMUM WIDTH 625  // TODO: IMPORTANT every time the side panel height is changed, the height value MUST be adjusted //680
